...
hl.log.debug("Test message.")
```

```py
import harrixlog as hl

hl.log.is_show_time_in_console = False
hl.log.is_show_color_in_console = True
hl.log.debug("Test message.")
hl.log.info("Test message.")
hl.log.warning("Test message.")
hl.log.error("Test message.")
hl.log.critical("Test message.")
```
...
class Log(object):
    ...
    def reverse_domain(self):
        ...
        hl.log.reverse_domain = "com.my-domain"
        hl.log.debug("Test message.")
        ```
        """
    ...
    def filename_log(self):
        ...
        hl.log.is_log_file = True
        hl.log.filename_log = "my-messages.log"
        hl.log.debug("Test message.")
        ```
        """
    ...
    def filename_error_log(self):
        ...
        hl.log.is_log_file = True
        hl.log.filename_error_log = "my-errors.log"
        hl.log.error("Test message.")
        ```
        """
    ...
    def is_show_time_in_console(self):
        ...
        hl.log.error("Test message.")
        # [ERROR] Test message.
        hl.log.is_show_time_in_console = True
        hl.log.error("Test message.")
    ...
    def is_show_color_in_console(self):
        ...
        hl.log.is_show_color_in_console = False
        hl.log.error("Test message.")
        ```
        """
    ...
    def text_debug(self, text):
        ...
        hl.log.info("x = " + hl.log.text_debug("Message"))
        ```
        """
    ...
    def text_info(self, text):
        ...
        hl.log.info("x = " + hl.log.text_info("Message"))
        ```
        """
        return self.__text_style(Log._Style.DEBUG, text)
    ...
    def text_warning(self, text):
        ...
        hl.log.info("x = " + hl.log.text_warning("Message"))
        ```
        """
    ...
    def text_error(self, text):
        ...
        hl.log.info("x = " + hl.log.text_error("Message"))
        ```
        """
    ...
    def text_critical(self, text):
        ...
        hl.log.info("x = " + hl.log.text_critical("Message"))
        ```
        """
    ...
    def text_normal(self, text):
        ...
        hl.log.info("x = " + hl.log.text_normal("Message"))
        ```
        """
    ...
    def text_red(self, text):
        ...
        hl.log.info("x = " + hl.log.text_red("Message"))
        ```
        """
    ...
    def text_green(self, text):
        ...
        hl.log.info("x = " + hl.log.text_green("Message"))
        ```
        """
    ...
    def text_yellow(self, text):
        ...
        hl.log.info("x = " + hl.log.text_yellow("Message"))
        ```
        """
    ...
    def text_blue(self, text):
        ...
        hl.log.info("x = " + hl.log.text_blue("Message"))
        ```
        """
    ...
    def text_magenta(self, text):
        ...
        hl.log.info("x = " + hl.log.text_magenta("Message"))
        ```
        """
    ...
    def text_cyan(self, text):
        ...
        hl.log.info("x = " + hl.log.text_cyan("Message"))
        ```
        """
    ...
    def text_red_background(self, text):
        ...
        hl.log.info("x = " + hl.log.text_red_background("Message"))
        ```
        """
    ...
    def text_green_background(self, text):
        ...
        hl.log.info("x = " + hl.log.text_green_background("Message"))
        ```
        """
    ...
    def text_yellow_background(self, text):
        ...
        hl.log.info("x = " + hl.log.text_yellow_background("Message"))
        ```
        """
    ...
    def text_blue_background(self, text):
        ...
        hl.log.info("x = " + hl.log.text_blue_background("Message"))
        ```
        """
    ...
    def text_magenta_background(self, text):
        ...
        hl.log.info("x = " + hl.log.text_magenta_background("Message"))
        ```
        """
    ...
    def text_cyan_background(self, text):
        ...
        hl.log.info("x = " + hl.log.text_cyan_background("Message"))
        ```
        """
    ...
    def text_italic(self, text):
        ...
        hl.log.info("x = " + hl.log.text_italic("Message"))
        ```
        """
    ...
    def text_underline(self, text):
        ...
        hl.log.info("x = " + hl.log.text_underlined("Message"))
        ```
        """
    ...
    def text_crossed_out(self, text):
        ...
        hl.log.info("x = " + hl.log.text_crossed_out("Message"))
        ```
        """
