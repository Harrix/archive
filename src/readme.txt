...
[http://blog.harrix.org/?p=1336](http://blog.harrix.org/?p=1336)
...
1. An example of using the plugin.
2. Example Markdown file.
3. Example display Markdown file шт Html with syntax highlighting code.
